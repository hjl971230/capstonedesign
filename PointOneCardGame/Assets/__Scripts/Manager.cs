...
public class Manager : MonoBehaviour
{
    ...
    public void SetScore()
    {
        ...
        BossTurnCount = GameObject.Find("BossTurnCount").GetComponent<Text>();
    }
    public void f_PrintScore()
    {
        ...
        BossTurnCount.text = "Active Pattern To : " + (PointOneCardGame.S.bossTurnActiveCount - PointOneCardGame.S.bossTurnCount);
    }
