...
[System.Serializable]
public class SlotDefPointOneCardGame
{
    public float x;
    public float y;
...
public class LayoutPointOneCardGame : MonoBehaviour
{
    ...
    public List<SlotDefPointOneCardGame> slotDefs;
    public SlotDefPointOneCardGame drawpile;
    public SlotDefPointOneCardGame discardpile;
    public SlotDefPointOneCardGame target;
